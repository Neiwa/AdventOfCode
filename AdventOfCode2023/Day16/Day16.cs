...
{
    public class Day16 : BaseAoc<Grid>
    {
        ...
        public int CalculateEnergy(Point startDirection, Point startLocation, Grid grid)
        {
            var lightMovement = new Grid<HashSet<Point>>(grid.Width, grid.Height, _ => new HashSet<Point>());

            var lightStack = new Stack<(Point Direction, GridCellReference<char> Location)>();
